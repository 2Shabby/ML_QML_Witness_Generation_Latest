...
\begin{enumerate}
    ...
    \item \textbf{Classification:} Linear SVM (baseline) and Transformer (advanced)
    \item \textbf{Witness Extraction:} $W = \sum_k w_k P_k$ from learned hyperplane
\end{enumerate}
...
\begin{itemize}
    \item Linear SVM: 85.6\% accuracy (interpretable witness)
    \item Transformer: 99.7--100\% accuracy (state-of-the-art)
\end{itemize}
